 ...
 */
export function getSearchSelectors(_ref) {
 ...
 * @param searchStateSelector Returns the Search sub-state of the store; (state: Object): Object
 */
export function getTextSelector(_ref2) {
 ...
 * @param searchStateSelector Returns the Search sub-state of the store; (state: Object): Object
 */
export function getResultSelector(_ref3) {
 ...
 * @param searchStateSelector Returns the Search sub-state of the store; (state: Object): Object
 */
export function getUnfilteredResultSelector(_ref4) {
